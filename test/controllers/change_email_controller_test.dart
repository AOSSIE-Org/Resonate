...
void main() {
  ...
  setUp(() {
    ...
    when(mockAccount.updateEmail(
            email: 'test2@test.com', password: "anyPassword"))
        .thenAnswer((_) => Future.value(mockUser));
  });
  test('test isEmailAvailable', () async {
    final result =
        await changeEmailController.isEmailAvailable('test2@test.com');
    expect(result, true);
  });
  ...
  testWidgets('test changeEmailInDatabases', (WidgetTester tester) async {
    ...
    final result = await changeEmailController.changeEmailInDatabases(
        'test2@test.com', tester.element(find.byType(Container)));
  ...
  testWidgets('test changeEmailInAuth', (WidgetTester tester) async {
    ...
    expect(result, true);
    verify(mockAccount.updateEmail(
            email: 'test2@test.com', password: "anyPassword"))
        .called(1);
  });
