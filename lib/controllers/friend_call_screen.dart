                    ...
                    Column(
                      ...
                      children: [
                        _buildUserInfoRow(
                          ...
                          controller.friendCallModel.value!.callerName,
                        ),
                        ...
                        _buildUserInfoRow(
                          ...
                          controller.friendCallModel.value!.recieverName,
                        ),
                      ],
                    ),
                    SizedBox(height: UiSizes.height_24_6),
        ...
        return Row(
          ...
          children: [
            ...
            _buildControlButton(
              ...
              onPressed: () async {
                await controller.onEndedCall({
                  "call_id": controller.friendCallModel.value!.docId,
                });
              },
