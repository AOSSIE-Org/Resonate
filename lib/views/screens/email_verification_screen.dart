                        ...
                        Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              Text(
                                "Resonate",
                                style: TextStyle(color: themeController.primaryColor.value, fontSize: UiSizes.size_25),
                              ),
                              ClipRRect(
                                borderRadius: BorderRadius.circular(100),
                                child: Material(
                                  child: InkWell(
                                    onTap: () => {Get.toNamed(AppRoutes.tabview)},
                                    child: Ink(
                              ...
                              Container(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    OtpTextField(
                                      textStyle: TextStyle(fontSize: UiSizes.size_14),
                                      fieldWidth: UiSizes.width_40,
                                      numberOfFields: 6,
                                      focusedBorderColor: const Color.fromARGB(224, 68, 170, 50),
                                      borderWidth: UiSizes.width_1_5,
                                      clearText: emailVerifyController.clearTextField.value,
                                      enabledBorderColor: const Color.fromARGB(155, 255, 193, 7),
                                      showFieldAsBox: true,
                                      //runs when every textfield is filled
                                      onSubmit: (String verificationCode) async {
                                        emailVerifyController.isVerifying.value = true;
                                        await emailVerifyController.verifyOTP(verificationCode);
                                        if (emailVerifyController.responseVerify.response == '{"message":"null"}') {
                                          String result = await emailVerifyController.checkVerificationStatus();
                                          if (result == "true") {
                                            customSnackbar("Verification Complete", "Congratulations you have verified your Email", MessageType.success);
                                            await emailVerifyController.setVerified();
                                            if (emailVerifyController.responseSetVerified.response == '{"message":"null"}') {
                                              ...
                                              emailVerifyController.isVerifying.value = false;
                                              customSnackbar('Oops', emailVerifyController.responseSetVerified.response, MessageType.error);
                                            }
                                          } else {
                                            emailVerifyController.isVerifying.value = false;
                                          ...
                                          customSnackbar('Oops', emailVerifyController.responseVerify.response, MessageType.error);
                                        }
                                      },
                                    ),
                                    ...
                                    Obx(
                                      () => Container(
                                        ...
                                        decoration: BoxDecoration(
                                            border: Border.all(color: themeController.primaryColor.value.withOpacity(0.6), width: UiSizes.width_3),
                                            borderRadius: BorderRadius.circular(70),
                                            gradient: emailVerifyController.resendIsAllowed.value
                                                ? themeController.createDynamicGradient()
                                                : const LinearGradient(colors: [Color.fromARGB(255, 74, 74, 74), Color.fromARGB(255, 68, 63, 63)])),
                                        child: SizedBox(
                                          height: UiSizes.height_45,
                                          width: UiSizes.width_294,
                                          child: ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(UiSizes.size_70), side: const BorderSide(width: 0, color: Colors.transparent)),
                                                  backgroundColor: Colors.transparent,
                                                  shadowColor: Colors.transparent),
                                              onPressed: emailVerifyController.resendIsAllowed.value
                                                  ? () {
                                              ...
                                              child: emailVerifyController.resendIsAllowed.value
                                                  ? Text(
                                                      "Resend OTP",
                                                      style: TextStyle(
                                                        color: Colors.black,
                                                  ...
                                                  : Row(
                                                      ...
                                                      children: [
                                                        Text(
                                                          "Resend OTP?",
                                                          style: TextStyle(fontSize: UiSizes.size_14, color: Colors.white),
                                                        ),
                                                        SizedBox(
                                                          width: UiSizes.width_111,
                                                        ),
                                                        CircularCountDownTimer(
                                                          textStyle: TextStyle(fontSize: UiSizes.size_12, color: AppColor.bgBlackColor),
                                                          isTimerTextShown: true,
                                                          isReverse: true,
                                                          onComplete: () => {emailVerifyController.resendIsAllowed.value = true},
                                                          width: UiSizes.width_33,
                                                          height: UiSizes.height_33,
                                                          duration: 30,
                                                          backgroundColor: themeController.primaryColor.value,
                                                          fillColor: const Color.fromARGB(255, 74, 74, 74),
                                                          ringColor: const Color.fromARGB(255, 130, 130, 130),
                                                        ),
                                                      ],
                                                    )),
                                        ),
                          ...
                          Align(
                            ...
                            child: GestureDetector(
                                ...
                                child: AnimatedContainer(
                                    ...
                                    width: emailVerifyController.isExpanded.value ? UiSizes.width_180 : UiSizes.width_35,
                                    // decoration: BoxDecoration(
