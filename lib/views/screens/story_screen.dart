...
class _StoryScreenState extends State<StoryScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(
        ()=> SafeArea(
          child: exploreStoryController.isLoadingStoryPage.value? Center(child: LoadingIndicator(indicatorType: Indicator.ballBeat, strokeWidth: 20,)):Column(
            children: [
              Container(
                          ...
                          Stack(
                            ...
                            children: [
                              ...
                              Obx(
                                () => LikeButton(
                                  isLikedByUser:
                                      widget.story.isLikedByCurrentUser.value,
